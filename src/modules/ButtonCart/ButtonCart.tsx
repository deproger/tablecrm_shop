      ...
      {useMemo(() => {
        if (type === 'product') {
          ...
          return (
            <button
              onClick={handleAdd}
              className="flex h-full w-fit w-fit items-center justify-center rounded bg-[#179C49] p-1 px-8 py-3 font-medium leading-[30px] text-white sm:max-w-80 "
            >
              В&nbsp;корзину
            </button>
          );
        ...
        if (type === 'common') {
          ...
          return (
            <button
              onClick={handleAdd}
              className="flex h-fit w-fit w-fit items-center justify-center rounded border-2 border-[#179C49] bg-[#179C49] px-4 py-2 font-medium leading-[30px] text-white sm:max-w-80 "
            >
              В&nbsp;корзину
            </button>
          );
