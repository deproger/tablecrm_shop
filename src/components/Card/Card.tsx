    ...
    >
      ...
      <div className="mt-2 flex flex-row gap-1">
        ...
        <Link
          ...
          className="flex h-fit w-fit w-fit items-center justify-center rounded border-2 border-[#179C49] bg-white px-4 py-2 font-medium leading-[30px] text-[#179C49] text-[#179C49] sm:max-w-80 "
        >
          Подробнее
        </Link>
      </div>
